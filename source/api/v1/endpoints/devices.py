...
async def create_device(device: DeviceIDBaseSchema,
...
async def get_device(device_id: IDType,
                     repository=Depends(device_repository)):
...
async def update_device(device_id: IDType,
...
async def patch_device(device_id: IDType,
                       device: DeviceUpdateBaseSchema,
                       repository=Depends(device_repository),
                       ):
...
async def delete_device(device_id: IDType,
                        repository=Depends(device_repository)):
